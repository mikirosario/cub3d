...
void	getbonusteximg(void)
{
	...
	"./bonustextures/doorright.xpm", &g_doorrightimg.texw, \
	&g_doorrightimg.texh);
	g_doorleftimg.mlx_img = mlx_xpm_file_to_image(g_screendata.mlx_ptr, \
	"./bonustextures/doorleft.xpm", &g_doorleftimg.texw, &g_doorleftimg.texh);
	g_portal.mlx_img = mlx_xpm_file_to_image(g_screendata.mlx_ptr, \
	"./bonustextures/portalanimation/portal1.xpm", &g_portal.texw, \
	&g_portal.texh);
	g_phrases.mlx_img = mlx_xpm_file_to_image(g_screendata.mlx_ptr, \
	"./bonustextures/textboxes/orenline1.xpm", &g_phrases.texw, \
	&g_phrases.texh);
	g_ending.mlx_img = mlx_xpm_file_to_image(g_screendata.mlx_ptr, \
	"./bonustextures/textboxes/ending1.xpm", &g_ending.texw, &g_ending.texh);
	g_skybox.mlx_img = mlx_xpm_file_to_image(g_screendata.mlx_ptr, \
	"./bonustextures/skybox.xpm", &g_skybox.texw, &g_skybox.texh);
}
