...
/*   Updated: 2020/09/24 19:00:16 by mrosario         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	displaygraphicsmode(void)
{
	if (g_keydata.m == 0)
		...
		g_config.screenw / 2 - 60, 10, 0x0000ff00, "Mode 0 Grafx");
	else if (g_keydata.m == 1)
		mlx_string_put(g_screendata.mlx_ptr, g_screendata.mlx_win, \
		g_config.screenw / 2 - 60, 10, 0x0000ff00, "Mode 1 Grafx");
	else if (g_keydata.m == 2)
		mlx_string_put(g_screendata.mlx_ptr, g_screendata.mlx_win, \
		g_config.screenw / 2 - 60, 10, 0x0000ff00, "Mode 2 Grafx");
}
