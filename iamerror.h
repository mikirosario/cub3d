...
/*   Updated: 2020/07/24 19:43:04 by mrosario         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define cubFileNotFound RED"Error\nFILE NOT FOUND, CHECK YOUR .CUB FILE PATH\n"RESET
#define weirdFD RED"Error\nYOUR GAME IS TRYING TO READ FROM STDIN, STDOUT OR STDERR... I DON'T KNOW WHAT TO SAY... THIS SHOULD NOT BE HAPPENING O_O\n"RESET
#define couldNotClose YELLOW"Error\nONE OR MORE FILES COULD NOT BE CLOSED\n"RESET
...
#define pathNOFail RED"NORTH WALL TEXTURE FILE (NO) DOES NOT EXIST AT SPECIFIED PATH; SEE QUANTUM PATH INFO AND CHECK YOUR MAP FILE\n"RESET
...
#define pathSOFail RED"SOUTH WALL TEXTURE FILE (SO) DOES NOT EXIST AT SPECIFIED PATH; SEE QUANTUM PATH INFO AND CHECK YOUR MAP FILE\n"RESET
...
#define pathWEFail RED"WEST WALL TEXTURE FILE (WE) DOES NOT EXIST AT SPECIFIED PATH; SEE QUANTUM PATH INFO AND CHECK YOUR MAP FILE\n"RESET
...
#define pathEAFail RED"EAST WALL TEXTURE FILE (EA) DOES NOT EXIST AT SPECIFIED PATH; SEE QUANTUM PATH INFO AND CHECK YOUR MAP FILE\n"RESET
...
#define pathSprFail RED"SPRITE TEXTURE FILE (S) DOES NOT EXIST AT SPECIFIED PATH; SEE QUANTUM PATH INFO AND CHECK YOUR MAP FILE\n"RESET
#define wallTexSizeFail YELLOW"WALL TEXTURE SIZE NOT FOUND, DEFAULTING TO 64; YOUR IMAGE MAY NOT DISPLAY CORRECTLY!!\n"RESET
#define wallTexSizeDif RED"DIFFERENT WALL TEXTURE SIZES! YOUR WALL TEXTURE SIZES MUST ALL BE THE SAME BY ORDER OF UN SECURITY COUNCIL; ABORTING PROGRAM\n"RESET
#define sprTexSizeFail YELLOW"SPRITE TEXTURE SIZE NOT FOUND, DEFAULTING TO 64; YOUR IMAGE MAY NOT DISPLAY CORRECTLY!!\n"RESET
...
#define outOfBounds RED"THE PLAYER CHARACTER (NSEW) MUST BE IN AN AREA BOUNDED BY WALLS\n"RESET
...
#define noPlayer RED"INVALID MAP: NO PLAYER FOUND; MAP MUST HAVE PLAYER STARTING LOCATION\n"RESET
